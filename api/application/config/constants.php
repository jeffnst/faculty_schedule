...
//FOR API
//define('BASE_URL','http://192.168.2.6/pkbmksi-web/api/');
//define('BASE_URL','http://localhost/Akhlak-Q/api/');
//ROLE USER

define('FAIL_STATUS', "FAIL");
define('FAIL_MESSAGE', "Proses Gagal");
define('FAIL_UPLOAD_MESSAGE', "Proses Upload Gagal");
define('OK_STATUS', "OK");
define('OK_MESSAGE', "Proses Berhasil");
...
define('NEW_CONTENT_CAPTION','Baru');
define('ACTIVE_CONTENT_STATUS','A');
define('ACTIVE_CONTENT_CAPTION','Aktif');
